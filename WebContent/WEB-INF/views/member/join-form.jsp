		...
		<table border="1">
			<tr>
				...
				<td><input type="text" name="userId" id="userId" size="10"
					...
					required />
					<button type="button" id="btnIdCheck">check</button> <span
					id="idCheck" class="valid-msg"> <c:if
							test="${not empty param.err and not empty joinValid.userId}">
	           	  	이미 존재하는 아이디 입니다.
	           	  </c:if>
				</span></td>
			</tr>
			<tr>
				...
				<td><input type="password" name="password" id="password"
					...
					required /> <span id="pwCheck" class="valid-msg"> <c:if
			...
			<tr>
				<td>휴대폰번호 :</td>
				<td><input id="tell" type="tel" name="tell"
					placeholder="숫자만 입력하세요"
					<c:if test="${not empty param.err and empty joinValid.tell}">
	           	  value="${joinForm.tell}"
	          </c:if>
					required /> <span id="tellCheck" class="valid-msg"> <c:if
							test="${not empty param.err and not empty joinValid.tell}">
